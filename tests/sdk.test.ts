...
describe('AdamikSDK', () => {
  ...
  describe('verify', () => {
      ...
      const apiResponse: AdamikEncodeResponse = {
        ...
        transaction: {
          ...
          encoded: [{
            ...
            raw: {
              format: 'RLP',
              value: '0xf86905850430e2340082520894098765432109876543210987654321098765432188016345785d8a0000801ba0...'
            }
          }]
        }
      };
    ...
    it('should return invalid for mismatched addresses', async () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors).toContain('Recipient address mismatch: expected 0x0987654321098765432109876543210987654321, got 0x1111111111111111111111111111111111111111');
    });
    ...
    it('should return invalid for mismatched amount', async () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors).toContain('Amount mismatch: expected 1000000000000000000, got 2000000000000000000');
    });
