...
describe("Decoders", () => {
  ...
  describe("SolanaDecoder", () => {
    ...
    it("should decode Solana transfer transaction (placeholder)", async () => {
      const rawTx =
    ...
    it("should decode Solana token transfer transaction", async () => {
      const rawTx =
        "";
      const decoded = await decoder.decode(rawTx);
    ...
    it("should decode Solana staking transfer transaction", async () => {
      const rawTx =
